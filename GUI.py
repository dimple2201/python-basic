...
#label
Label(window, text="Hello pycharm to tkinter",bg='pink').grid(row=0,column=1,sticky=W)



# button
Button(window, text='Submit',bg='yellow').grid(row=1,column=1,sticky=W)


# another level
Label(window, text='Defination',bg='red',fg='white',font='aerial 12 bold').grid(row=1,column=0 ,sticky=W)
...
# enter something to know-----> create a label for this!!
